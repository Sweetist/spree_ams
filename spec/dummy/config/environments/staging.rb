Rails.application.configure do
  ...
  config.action_controller.asset_host = 'https://dy2vsve5dm0o2.cloudfront.net'
  config.action_mailer.asset_host = 'https://dy2vsve5dm0o2.cloudfront.net'
  ...
  # OVERRIDE MAIL SETTINGS FOR STAGING
  ...
  config.action_mailer.smtp_settings = {
    ...
    user_name: "staging@onsweet.co",
    password: "getsweet00"
  }

  STAGING_EMAIL = "staging@onsweet.co"
